    ...
    <div class="container">
      <div class="row">
        <div class="p-5 col-md-7 d-flex flex-column justify-content-center">
          ...
          <p class="mb-4 lead">"Live Free or Die"&nbsp;</p>
        </div>
        <div class="p-5 col-md-5">
          <h3 class="mb-3">Welcome</h3>
          <form>
            <div class="form-group"><label>Name</label> <input class="form-control" v-model="loginForm.username"
                                                               placeholder="Type here">
              <div class="form-group"><label>Password</label><input class="form-control" v-model="loginForm.password"
                                                                    placeholder="Type here"></div>
            </div>
            <button class="btn mt-4 btn-block btn-outline-dark p-2" v-on:click="login"><b>Login</b></button>
          </form>
        </div>
      </div>
    </div>
    ...
    login () {
      this.$axios
        ...
        .then(successResponse => {
          ...
          if (failureResponse.data.code === 400) {
            this.$router.replace({path: '/loginFailed'})
          }
        })
 ...
 */
  ...
  *::after {
  ...
  .form-control:focus {
    ...
    border-color: #ffbfbb;
    outline: 0;
    box-shadow: 0 0 0 0.2rem rgba(255, 71, 59, 0.25);
  }
  ...
  .btn-primary:focus, .btn-primary.focus {
    box-shadow: 0 0 0 0.2rem rgba(255, 71, 59, 0.5);
  }
  ...
  .btn-secondary:focus, .btn-secondary.focus {
    box-shadow: 0 0 0 0.2rem rgba(0, 219, 153, 0.5);
  }
  ...
  .btn-info:focus, .btn-info.focus {
    box-shadow: 0 0 0 0.2rem rgba(201, 152, 0, 0.5);
  }
  ...
  .custom-control-input:focus ~ .custom-control-label::before {
    box-shadow: 0 0 0 1px white, 0 0 0 0.2rem rgba(255, 71, 59, 0.25);
  }
  ...
  .custom-checkbox .custom-control-input:disabled:checked ~ .custom-control-label::before {
    background-color: rgba(255, 71, 59, 0.5);
  }
  ...
  .custom-select:focus {
    border-color: #ffbfbb;
    outline: 0;
    box-shadow: 0 0 0 0.2rem rgba(255, 191, 187, 0.5);
  }
  ...
  .popover-header {
    ...
    border-top-left-radius: calc(0.72rem - 1px);
    border-top-right-radius: calc(0.72rem - 1px);
  }
  ...
  button.bg-primary:focus {
    background-color: #ff1708 !important;
  }
  ...
  .border-primary {
    border-color: #FF473B !important;
  }

  .border-secondary {
    border-color: #00DB99 !important;
  }
  ...
  .text-secondary {
    color: #00DB99 !important;
  }

  a.text-secondary:hover, a.text-secondary:focus {
    color: #00a875 !important;
  }
  ...
  .section-primary:before {
    ...
    height: 100%;
    content: ' ';
    background: rgba(255, 71, 59, 0.75);
  }
  ...
  .section-secondary:before {
    ...
    height: 100%;
    content: ' ';
    background: rgba(0, 219, 153, 0.75);
  }
  ...
  .section-info:before {
    ...
    height: 100%;
    content: ' ';
    background: rgba(201, 152, 0, 0.75);
  }
